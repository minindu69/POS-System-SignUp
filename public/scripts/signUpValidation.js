document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const validateEmail = () => {
        ...
        if (trimmedEmail.includes(" ")) {
            ...
            //styles(inline)
            email.style.backgroundImage = "url('assets/images/warning.png')";
            ...
            //styles(inline)
            email.style.backgroundImage = "url('assets/images/success-final.png')";
            email.style.backgroundSize = "18px";
    ...
    const togglePassword = (iconClass)=>{
        ...
        if(password.type === "password"){
            password.type = "text";
            iconClass.style.backgroundImage = "url('assets/images/show.png')";
        }else{
            password.type = "password";
            iconClass.style.backgroundImage = "url('assets/images/hide.png')";
        }
    }
